...
import com.suarkadipa.fragment.LMResourcesCalculatorFragment;
import com.suarkadipa.fragment.MontlyBudgetFragment;
import com.suarkadipa.fragment.ServiceScheduleFragment;
import com.suarkadipa.fragment.LMSpeedUpCalculatorFragment;
...
public class MainActivity extends SherlockFragmentActivity {
    ...
    Fragment fragment5 = new LMSpeedUpCalculatorFragment();
    Fragment fragment6 = new LMResourcesCalculatorFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Generate title
        title = new String[]{getString(R.string.fragment_1_title),
                getString(R.string.fragment_2_title),
                getString(R.string.fragment_3_title),
                getString(R.string.fragment_4_title),
                getString(R.string.fragment_5_title),
                getString(R.string.fragment_6_title)};

        // Generate subtitle
        subtitle = new String[]{getString(R.string.fragment_1_subtitle),
                getString(R.string.fragment_2_subtitle),
                getString(R.string.fragment_3_subtitle),
                getString(R.string.fragment_4_subtitle),
                getString(R.string.fragment_5_subtitle),
                getString(R.string.fragment_6_subtitle)};
